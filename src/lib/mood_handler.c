...
const char *easteregg_messages[MOOD_COUNT] = {
    [goth] =
        ("The frantic race took them to the great hall, where the creature "
    ...
    [bubbly] =
        ("Error: Your device has been infected by a virus. "
    ...
    [shy] =
        ("Later that night, Jeff's mother woke to a sound coming from the "
         "bathroom. It sounded as if someone was crying. She slowly walked "
         "over "
